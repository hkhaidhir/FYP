...
import com.ebookfrenzy.uifyp.adapter.AllCategoryAdapter;
import com.ebookfrenzy.uifyp.model.AllCategoryModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent back = new Intent(AllCategory.this, HomepageActivity.class);
                startActivity(back);
                finish();
            }
        });
        ...
        allCategoryModelList.add(new AllCategoryModel(1,R.drawable.ic_category_sports));
        allCategoryModelList.add(new AllCategoryModel(1,R.drawable.ic_category_gym));
        allCategoryModelList.add(new AllCategoryModel(1,R.drawable.ic_category_electronic));
        allCategoryModelList.add(new AllCategoryModel(1,R.drawable.ic_category_car));
        allCategoryModelList.add(new AllCategoryModel(1,R.drawable.ic_category_book));
